...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('template-admin') }}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Shop handmade</span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="{{ asset('template-client') }}/img/avatar1.png" class="img-circle elevation-2"
                alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('inventory.manager') }}" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Quản lý tồn kho
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('chatZalo.index') }}" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Tạo Widget chat zalo
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
          </li>
